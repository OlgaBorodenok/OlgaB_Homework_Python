class StringUtils:
   #Класс с полезными утилитами для обработки и анализа строк
    ...
    #-> str: Принимает на вход текст, делает первую букву заглавной и возвращает этот же текст
    ...
    def contains(self, string: str, symbol: str):
        ...
        #-> bool: Возвращает `True`, если строка содержит искомый символ и `False` - если нет
        #         Параметры:
    ...
    def delete_symbol(self, string: str, symbol: str):
        # -> str:        Удаляет все подстроки из переданной строки
        #         Параметры:
        #             `string` - строка для обработки
